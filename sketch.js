...
function preload() {
    imagenPelota = loadImage('./assets/spoot.png');
    imagenRaqueta = loadImage('./assets/raqueta1.png');
    imagenComputadora = loadImage('./assets/raqueta2.png');
    imagenFondo = loadImage('./assets/escenario-chihiro-124-WEB.jpg');
    sonidoRaqueta = loadSound('./assets/446100__justinvoke__bounce.wav');
    sonidoGol = loadSound('./assets/274178__littlerobotsoundfactory__jingle_win_synth_02.wav');
}


function setup() {
    createCanvas(800, 400);
    pelota = new Pelota(400, 200, 80,5,5);
